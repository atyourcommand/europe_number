...
<?php
   ...
   $cat_slug      = en_get_cat_slug();                   // e.g. 'esim-europe'
   $category_name = en_get_cat_name();                   // e.g. 'Europe'
...
<script id="pill_slides" type="text/javascript">
   ...
   var divID = 'pillSlides';
   imageArray = <?php echo json_encode($category_slides)?>;
      ...
      <div class="flex max-lg:flex-col lg:flex-row max-lg:gap-[40px] lg:gap-10 lg:items-center pt-10">
         ...
         <div class="flex justify-end flex-1 max-lg:self-center heading max-lg:pb-5">
            <center class="lg:text-right">
               ...
               <div class="flex max-lg:justify-center lg:justify-end gap-x-2 mt-3">
         ...
         <div class="pillSlideWrap flex flex-col flex-2 relative min-h-[280px] md:min-h-[380px]">
            ...
            <div id="pillSlides" class="min-h-[280px] md:min-h-[380px] flex bg-white shadow-sm ring-1 ring-black/5 flex-3 overflow-hidden" style="border-radius:24px 8px 24px 8px;">
               <div class="flex max-md:flex-col w-full p-6 md:p-10 gap-[15px] backdrop-brightness-70">
            ...
            <!-- Country flag badge -->
            <img class="w-[80px] absolute max-md:top-[-40px] max-md:left-[50%] max-md:ml-[-40px] md:top-[50%] md:left-[20px] md:mt-[-40px] border-[3px] border-white rounded-full"
